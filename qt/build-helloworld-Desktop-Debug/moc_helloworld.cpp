...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_helloworld_t, stringdata) + ofs \
...
const QMetaObject helloworld::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_helloworld.data,
      qt_meta_data_helloworld,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_helloworld.stringdata))
