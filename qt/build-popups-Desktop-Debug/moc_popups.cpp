...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Popups_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 68, 15)
    ...
    "Popups\0onInfoClicked\0\0onCritClicked\0"
    "onWarnClicked\0onQuestionClicked\0"
    "onPromptClicked\0"
};
...
void Popups::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Popups *_t = static_cast<Popups *>(_o);
        switch (_id) {
        case 0: _t->onInfoClicked(); break;
        case 1: _t->onCritClicked(); break;
        case 2: _t->onWarnClicked(); break;
        case 3: _t->onQuestionClicked(); break;
        case 4: _t->onPromptClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Popups::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Popups.data,
      qt_meta_data_Popups,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Popups.stringdata))
